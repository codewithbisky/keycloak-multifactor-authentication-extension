...
import com.codewithbisky.authentication.extension.exception.TwoFactoBaseException;
...
import com.codewithbisky.authentication.extension.webauthn.entity.LoginFlowEntity;
    ...
    public LoginStartResponse startLogin(LoginStartRequest loginStartRequest) throws JsonProcessingException {
        ...
        StartAssertionOptions options =
                StartAssertionOptions.builder()
                        ...
                        .build();
        AssertionRequest assertionRequest = RelyingPartyConfiguration.relyingParty(this,user).startAssertion(options);
