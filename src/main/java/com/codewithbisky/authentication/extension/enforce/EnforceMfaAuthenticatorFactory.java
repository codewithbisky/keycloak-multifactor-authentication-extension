package com.codewithbisky.authentication.extension.enforce;
...
public class EnforceMfaAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return ProviderConfigurationBuilder.create()
										   .property().name(EnforceMfaAuthenticator.CONFIG_OPTIONAL_NAME).label("MFA setup is optional").helpText("Users can skip the setup of MFA").type(ProviderConfigProperty.BOOLEAN_TYPE).defaultValue(EnforceMfaAuthenticator.CONFIG_OPTIONAL_DEFAULT_VALUE)
										   .add().build();
	}
